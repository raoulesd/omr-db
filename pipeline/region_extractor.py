...
def extract_region(image: np.ndarray, region_name: str, predetermined_size: tuple = None) -> np.ndarray:
...
def extract_regions(image: np.ndarray, region_names: list, predetermined_size: tuple = None) -> dict:
